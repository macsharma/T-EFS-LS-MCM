...
"""
#import os
#path = 'D:\\Mega\\phd\\classification_datasets\\label_partition\\label_noise\\temperature_code_SVM\\SVM_L1_LINP'
#os.chdir(path)
from utils.utils import utils
from utils.CyclicLR import CyclicLR
import numpy as np
class LSMCM_classifier:
    def __init__(self,C1 = 0.0, C2 = 1e-03, C3 = 1e-03, gamma =1e-02, kernel_type = 'linear_primal', batch_sz =128, iterMax1 =1000, iterMax2 =1, eta = 0.01, 
             ...
             n_components = 100, do_pca_in_selection = False, do_upsample = False,compress_type = 'saturate'):
        self.C1 = C1
        self.C2 = C2
        self.C3 = C3
        self.gamma = gamma
